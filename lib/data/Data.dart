...
//
// List<Map<String,dynamic>> postRespons=[
//    {
//      'user':{
//        'name':'hussam',
//        'image':'https://sa.lovepik.com/image-400195163/character.html',
//      },
//      'post':{
//        'content':'the first post',
//        'image':'https://unsplash.com/s/photos/view',
//        'numlike':15
//      }
//
//    },
...
//  ];
//
// List <PostRespons> posts = postRespons.map((e) => PostRespons.fromjson(e)).toList();
//
//
...
List <PostRespons> posts = postsResponse.map((e) => PostRespons.fromJson(e)).toList();